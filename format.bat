...
java -jar google-java-format-1.5-all-deps.jar -r src/main/java/com/sponsorplugin/sponsorplugin/*
java -jar google-java-format-1.5-all-deps.jar -r src/main/java/com/sponsorplugin/sponsorplugin/commands/*
java -jar google-java-format-1.5-all-deps.jar -r src/main/java/com/sponsorplugin/sponsorplugin/events/*
exit /b 0
